...
var symmetry = 4 + Math.random() * 8;
var strokeThickness = 1;
var strokeAlpha = 10;
var pointsSize = 0;
var maxDistance = 75 + Math.random() * 150;
...
function createTitle() {
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        sketchname = createA("https://www.openprocessing.org/sketch/418492");
        ...
        document.getElementById('thisurl').innerHTML = "mandala";
        document.getElementById('thisurl').setAttribute('target', '_blank');

        sketchdescription = createP("[ a mandala is a spiritual and ritual symbol in Hinduism and Buddhism, representing the universe. ]");
